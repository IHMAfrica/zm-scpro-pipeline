...
CREATE TABLE IF NOT EXISTS public.carepro_all_interactions (
  id            SERIAL NOT NULL,
  InteractionId TEXT,
  PatientId TEXT,
  CareProPatientId TEXT,
  ARTNumber TEXT,
  Sex TEXT,
  DOB TEXT,
  FirstName TEXT,
  ...
  NextVisitDate TEXT,
  InteractionProvider TEXT,
  FacilityName TEXT,
  careProFacilityId TEXT,
  District TEXT,
  Provience TEXT,
  ServiceName TEXT,
  ARTStartDate TEXT,
  CurrentVLCopies TEXT,
  CurrentVLDate TEXT,
  CD4Count TEXT,
  CD4CountDate TEXT,
  CD4Percent TEXT,
  CD4PercentDate TEXT,
  CurrentARTRegimen TEXT,
  CurrentARTRegimenDispensationDate TEXT,
  NameofthePrescribedDrug TEXT,
  PrescriptionDate TEXT,
  DSD TEXT,
  LastTestResult TEXT,
  DetermineTestResult TEXT,
  BiolineTestResult TEXT,
